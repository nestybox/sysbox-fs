...
var ProcSysKernel_Handler = &ProcSysKernel{
	domain.HandlerBase{
		...
		EmuNodesMap: map[string]domain.EmuNode{
			"domainname":    domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0644))},
			"hostname":      domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0644))},
			"kptr_restrict": domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0644))},
			"ngroups_max":   domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0444))},
			"cap_last_cap":  domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0444))},
			"panic":         domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0644))},
			"panic_on_oops": domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0644))},
			"printk":        domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0644))},
			"sysrq":         domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0644))},
			"pid_max":       domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0644))},
		},
