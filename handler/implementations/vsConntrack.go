...
func (h *VsConntrackHandler) Lookup(n domain.IOnode, pid uint32) (os.FileInfo, error) {
...
func (h *VsConntrackHandler) Getattr(n domain.IOnode, pid uint32) (*syscall.Stat_t, error) {
...
func (h *VsConntrackHandler) Open(n domain.IOnode, pid uint32) error {
...
func (h *VsConntrackHandler) Read(n domain.IOnode, pid uint32,
...
func (h *VsConntrackHandler) Write(n domain.IOnode, pid uint32,
	buf []byte) (int, error) {
...
func (h *VsConntrackHandler) ReadDirAll(n domain.IOnode, pid uint32) ([]os.FileInfo, error) {
	return nil, nil
}

func (h *VsConntrackHandler) FetchFile(n domain.IOnode, c domain.ContainerIface) (string, error) {
...
func (h *VsConntrackHandler) PushFile(n domain.IOnode, c domain.ContainerIface, newValInt int) error {
