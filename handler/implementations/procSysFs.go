...
var ProcSysFs_Handler = &ProcSysFs{
	domain.HandlerBase{
		...
		EmuNodesMap: map[string]domain.EmuNode{
			"file-max":            domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0644))},
			"nr-open":             domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0644))},
			"protected_hardlinks": domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0600))},
			"protected_symlinks":  domain.EmuNode{domain.EmuNodeFile, os.FileMode(uint32(0600))},
		},
