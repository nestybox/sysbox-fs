...
func (h *VsConnReuseModeHandler) Lookup(n domain.IOnode, pid uint32) (os.FileInfo, error) {
...
func (h *VsConnReuseModeHandler) Getattr(n domain.IOnode, pid uint32) (*syscall.Stat_t, error) {
...
func (h *VsConnReuseModeHandler) Open(n domain.IOnode, pid uint32) error {
...
func (h *VsConnReuseModeHandler) Read(n domain.IOnode, pid uint32,
...
func (h *VsConnReuseModeHandler) Write(n domain.IOnode, pid uint32,
	buf []byte) (int, error) {
...
func (h *VsConnReuseModeHandler) ReadDirAll(n domain.IOnode, pid uint32) ([]os.FileInfo, error) {
	return nil, nil
}

func (h *VsConnReuseModeHandler) FetchFile(n domain.IOnode, c domain.ContainerIface) (string, error) {
...
func (h *VsConnReuseModeHandler) PushFile(n domain.IOnode, c domain.ContainerIface, newValInt int) error {
