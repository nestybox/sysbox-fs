...
func (h *ProcDiskstatsHandler) Close(n domain.IOnodeIface) error {
...
func (h *ProcDiskstatsHandler) GetService() domain.HandlerServiceIface {
	return h.Service
}
...
func (h *ProcDiskstatsHandler) SetService(hs domain.HandlerServiceIface) {
	h.Service = hs
}
