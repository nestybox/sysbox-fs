...
func (_m *HandlerServiceIface) HandlerDB() map[string]domain.HandlerIface {
	ret := _m.Called()

	var r0 map[string]domain.HandlerIface
	if rf, ok := ret.Get(0).(func() map[string]domain.HandlerIface); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]domain.HandlerIface)
		}
	}
